    ...
    <ContentBlock
      ...
      secondContent={
        <P className="scrollable">
          ...
          leren we samen.
          <br />
          Per project bekijken wij welke partners we kunnen betrekken. Partners
          die elkaar vaak nog niet kennen, maar na 1 keer samen iets gedaan te
          hebben, gebeurt dat vaker!
          <br />
          <br />
