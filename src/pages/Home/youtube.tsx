...
const Youtube = () => {
  return (
    <div className={"h-100 d-flex align-items-center"} style={{backgroundImage: "url(/stadslabzeist/img/svg/Website-Achtergrond-roze.svg)", backgroundSize: "cover", position: "relative"}}>
